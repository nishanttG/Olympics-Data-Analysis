...
st.sidebar.image("https://res.cloudinary.com/vistaprint/images/c_scale,w_448,h_299,dpr_2/f_auto,q_auto/v1705414606/ideas-and-advice-prod/en-us/900px-Olympic_flag.svg_/900px-Olympic_flag.svg_.png?_i=AA",width=200)
...
if user_menu == 'Overall Analysis':
    ...
    fig= px.line(athelete_over_time, x='Year',y='Name')
